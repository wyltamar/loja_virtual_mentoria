...
@SequenceGenerator(name = "seq_boleto_juno", sequenceName = "seq_boleto_juno", initialValue = 1, allocationSize = 1)
public class BoletoJuno implements Serializable {
	...
	/*
	 * Mostra uma tela de checkout da Juno com os boletos, pix e cartões pagos ou
	 * vencidos
	 */
