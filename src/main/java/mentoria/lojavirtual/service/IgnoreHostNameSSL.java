...
public class IgnoreHostNameSSL implements HostnameVerifier, Serializable {
	...
	private static final HostnameVerifier defaultRostNameVerify = HttpsURLConnection.getDefaultHostnameVerifier();
	...
	public boolean verify(String hostName, SSLSession session) {
		...
		if(trustedHosts.contains(hostName)) {
			...
			return defaultRostNameVerify.verify(hostName, session);
		}
	}
